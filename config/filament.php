...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This sets the URL prefix for the Filament admin panel.
    |
    */
    'path' => 'admin', // So login URL will be http://localhost/admin/login
    ...
    |--------------------------------------------------------------------------
    |
    | The guard used to authenticate Filament admin users.
    |
    */
    'auth' => [
    ...
    |--------------------------------------------------------------------------
    |
    | If you are using a different model for admin users, set it here.
    |
    */
    // 'user_provider' => null,
